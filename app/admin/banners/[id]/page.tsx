...
export default function EditBannerPage() {
  ...
  const fetchBanner = async () => {
    try {
      ...
      setMobilePreviewUrl(banner.mobileImage || null);
    } catch (error) {
    ...
    try {
      ...
      let imageUrl =
        formData.image instanceof File
          ...
          : formData.image;
      let mobileImageUrl =
        formData.mobileImage instanceof File
          ? await uploadToCloudinary(formData.mobileImage)
...
<p className="text-sm text-muted-foreground mt-1">
                  1920×600 px • 16:5 • ≤ 2 MB • JPG/PNG/WebP
                </p>
                {previewUrl && (
                  <div className="w-64 h-36 rounded overflow-hidden border mt-2">
                    <img src={previewUrl} className="object-cover w-full h-full" alt="Desktop preview" />
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                {mobilePreviewUrl && (
                  <div className="w-40 h-72 rounded overflow-hidden border mt-2">
                    <img
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  1080×1920 px • 9:16 • ≤ 1.5 MB • JPG/PNG/WebP
                </p>
              </div>
            </CardContent>
          </Card>
